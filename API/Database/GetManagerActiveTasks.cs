...
namespace API.Database
{
    public class GetManagerActiveTasks : IReadAllAssignments
    {
        public List<Assignment> GetAssignments(int id)
        {
            ...
            assignment a join employee e on (a.AssignedByEmp_ID = e.Emp_ID) WHERE AssignedByEmp_ID = @id and IsManagerApproved = 0 and AssignStatus = 'Awaiting Manager Approval'";
