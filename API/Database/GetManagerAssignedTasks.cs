...
namespace API.Database
{
    public class GetManagerAssignedTasks : IReadAllAssignments
    {
        public List<Assignment> GetAssignments(int id)
        {
            ...
            ToName, a.Assess_ID FROM assignment a join employee e on (a.AssignedByEmp_ID = e.Emp_ID) join employee ep on (a.AssignedToEmp_ID=ep.Emp_ID) WHERE AssignedByEmp_ID = @id and IsManagerApproved = 0";
